...
<body id="page-top">
        ...
        <div class="container-fluid p-0">
            <div class="row g-0">
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="{{ asset('images/smk-1.jpg') }}" title="Gambar Sekolah">
                        <img class="img-fluid portfolio-img" src="{{ asset('images/smk-1.jpg') }}" alt="Sekolah Informatika Utama" />
                ...
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="{{ asset('images/smk-2.jpg') }}" title="Gambar Sekolah">
                        <img class="img-fluid portfolio-img" src="{{ asset('images/smk-2.jpg') }}" alt="Sekolah Informatika Utama" />
                        <div class="portfolio-box-caption">
                            <div class="project-category text-white-50">Galeri</div>
                            <div class="project-name">Siswa Prakerin Tahun 2024</div>
                        </div>
                ...
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="{{ asset('images/smk-3.jpg') }}" title="Gambar Sekolah">
                        <img class="img-fluid portfolio-img" src="{{ asset('images/smk-3.jpg') }}" alt="Sekolah Informatika Utama" />
                        <div class="portfolio-box-caption">
                            <div class="project-category text-white-50">Galeri</div>
                            <div class="project-name">Siswa Prakerin Tahun 2024</div>
                        </div>
    ...
    <script>
        ...
        document.getElementById('continueBtn').addEventListener('click', function() {
            ...
            window.location.href = '{{ route("login") }}'; // Ganti dengan URL yang diinginkan
        });
    </script>
