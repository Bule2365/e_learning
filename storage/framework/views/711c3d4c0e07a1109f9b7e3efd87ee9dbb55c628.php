...
<head>
    ...
    <style>
        body {
            margin: 0;
            overflow: hidden;
            background: linear-gradient(135deg, #673ab7 0%, #5e35b1 50%, #b39ddb 100%);
            min-height: 100vh;
            display: flex;
            align-items: center;
        ...
        .error-code {
            ...
            text-shadow: 2px 2px 4px rgba(103, 58, 183, 0.3);
        }
...
<body>
    ...
    <div class="error-container">
        ...
        <div class="error-description">
            Maaf, layanan kami sedang dalam pemeliharaan.<br>
    ...
    <script>
        ...
        renderer.setClearColor(0x673ab7, 0.05);
        ...
        const ambientLight = new THREE.AmbientLight(0x673ab7, 0.2);
...
<?php /**PATH C:\xampp\htdocs\e_learning\resources\views/errors/503.blade.php ENDPATH**/ ?>