...
<head>
    ...
    <!-- Custom Styles -->
    <link rel="stylesheet" href="<?php echo e(asset('styleAdmin.css')); ?>">
    ...
    <div class="wrapper">
        ...
        <aside id="sidebar">
            <ul class="sidebar-nav">
                ...
                <!-- Data Siswa -->
                <li class="sidebar-item">
                    <a href="<?php echo e(route('admin.exams.index')); ?>" class="sidebar-link">
                        <i class="bi bi-person"></i> Data Ujian Siswa
                    </a>
                </li>
                <!-- Data Kelas -->
                <li class="sidebar-item">
                    <a href="<?php echo e(route('admin.classes.index')); ?>" class="sidebar-link">
                        <i class="bi bi-person-bounding-box"></i> Data Kelas
                    </a>
                </li>
                <!-- Data Mata Pelajaran -->
                <li class="sidebar-item">
                    <a href="<?php echo e(route('subjects.index')); ?>" class="sidebar-link">
            ...
            <div class="container-fluid py-4">
                ...
                <?php if(session('success')): ?>
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <strong><i class="bi bi-check-circle me-2"></i> Success!</strong> <?php echo e(session('success')); ?>
                ...
                <?php if(session('error')): ?>
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        <strong><i class="bi bi-exclamation-triangle me-2"></i> Error!</strong> <?php echo e(session('error')); ?>
...
<?php /**PATH C:\xampp\htdocs\e_learning\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>