                ...
                <div class="input-group">
                    <form action="<?php echo e(route('users.index')); ?>" method="GET" class="d-flex justify-content-between gap-3">
                        ...
                        <select name="role" class="form-select w-25 shadow-sm" onchange="this.form.submit()">
                            <option value="siswa" <?php echo e($selectedRole == 'siswa' ? 'selected' : ''); ?>>Siswa</option>
                            <option value="guru" <?php echo e($selectedRole == 'guru' ? 'selected' : ''); ?>>Guru</option>
                        </select>

                        <!-- Dropdown Tahun (Hanya muncul jika peran yang dipilih adalah siswa) -->
                        <?php if($selectedRole == 'siswa'): ?>
