...
<div class="container mt-4">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-12 col-md-4">
            <form action="{{ route('users.import') }}" method="POST" enctype="multipart/form-data" class="d-flex flex-column gap-2">
                @csrf
                <button type="submit" class="btn btn-secondary w-100 btn-lg" data-bs-toggle="tooltip" title="Import Data dari Excel">
    ...
    <div class="mb-4">
        <form action="{{ route('users.index') }}" method="GET" class="d-flex justify-content-between gap-3">
            <input type="text" name="search" class="form-control w-75" placeholder="Cari pengguna..." value="{{ request()->search }}">
