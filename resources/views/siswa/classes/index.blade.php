                    ...
                    <tr>
                        ...
                        <td>
                            @if ($user->kelas->isEmpty())
                                <!-- Cek jika siswa belum bergabung dengan kelas apapun -->
                            ...
                            @else
                                <button class="btn btn-secondary btn-sm" disabled>Sudah Bergabung</button>
                                <!-- Jika sudah bergabung dengan kelas lain -->
                            @endif
                        </td>
                    </tr>
                @endforeach
