                ...
                <div class="card shadow-lg border-0">
                    <div class="card-header bg-primary py-3">
                        <h3 class="h4 mb-0 text-white fw-bold">
                            <i class="bi bi-pencil-square me-2"></i>Edit Data Kelas
                        </h3>
                    </div>
                    <div class="card-body p-4">
                        <form action="<?php echo e(route('admin.classes.update', $class->id)); ?>" method="POST"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e_learning\resources\views/admin/classes/edit.blade.php ENDPATH**/ ?>