...
<div class="main-container">
        <div class="content-wrapper">
            <!-- Back Button Icon -->
            <a href="<?php echo e(url('/')); ?>" class="back-icon" id="backButton">
    ...
    <script>
        ...
        if (window.innerWidth >= 768) {
            const anim = lottie.loadAnimation({
                ...
                loop: true,
                autoplay: true,
                path: '<?php echo e(asset('animations/Animation-1739151970151.json')); ?>' // Fixed the animation path
            });
        }
...
</html><?php /**PATH C:\xampp\htdocs\e_learning\resources\views/auth/login.blade.php ENDPATH**/ ?>