                        ...
                        <div class="exam-card card h-100">
                            <div class="card-body p-4">
                                        ...
                                        <?php
                                            ...
                                            $shortTitle =
                                                count($titleWords) > 7
                                                    ...
                                                    : $exam->title;
                                        ?>
                                        <h3 class="card-title mb-1"><?php echo e($shortTitle); ?></h3>

                                        <p class="card-subtitle">
                                            <?php echo e($exam->kelas->name); ?> - <?php echo e($exam->mataPelajaran->name); ?>
                                ...
                                <div class="action-buttons">
                                    <a href="<?php echo e(route('guru.exams.show', $exam->id)); ?>" class="btn btn-outline-primary">
                                        <i class="bi bi-eye me-2"></i> Detail
                                    </a>
                                    <a href="<?php echo e(route('guru.exams.add_questions', $exam->id)); ?>" class="btn btn-primary">
                                    ...
                                    <button class="btn btn-danger" data-bs-toggle="modal"
                                        ...
                                        onclick="setDeleteForm('<?php echo e(route('guru.exams.destroy', $exam->id)); ?>')">
