...
<?php $__env->startSection('content'); ?>
    <div class="container my-5">
        ...
        <form action="<?php echo e(route('guru.exams.store')); ?>" method="POST" class="shadow p-4 rounded bg-light">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-3">
                ...
                <input type="text" id="class_name" class="form-control" value="<?php echo e($class->name); ?>" readonly disabled>
            </div>
...
<?php echo $__env->make('guru.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e_learning\resources\views/guru/exams/create.blade.php ENDPATH**/ ?>