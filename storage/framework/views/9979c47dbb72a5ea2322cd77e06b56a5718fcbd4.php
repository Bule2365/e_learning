                ...
                <div class="card shadow-lg border-0 rounded-3">
                    <div class="card-header bg-primary py-3">
                        <h3 class="h4 mb-0 text-white fw-bold">
                            <i class="bi bi-file-plus me-2"></i>Tambah Mata Pelajaran
                        </h3>
                    </div>
                    <div class="card-body p-4">
                        <form action="<?php echo e(route('subjects.store')); ?>" method="POST" class="needs-validation" novalidate>
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e_learning\resources\views/admin/subjects/create.blade.php ENDPATH**/ ?>