    ...
    <div class="container-fluid px-4 py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex align-items-center">
                <span class="text-muted me-2"><?php echo e(date('d M Y')); ?></span>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <h2 class="dashboard-stat"><?php echo e($jumlahSiswa); ?></h2>
                                <div class="mt-3 d-flex align-items-center">
                                    <i
                                        class="bi <?php echo e($persenSiswa >= 0 ? 'bi-arrow-up-short text-success' : 'bi-arrow-down-short text-danger'); ?>"></i>
                                    <span class="small fw-medium <?php echo e($persenSiswa >= 0 ? 'text-success' : 'text-danger'); ?>">
                                        <?php echo e(abs($persenSiswa)); ?>%
                                    </span>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <h2 class="dashboard-stat"><?php echo e($jumlahGuru); ?></h2>
                                <div class="mt-3 d-flex align-items-center">
                                    <i
                                        class="bi <?php echo e($persenGuru >= 0 ? 'bi-arrow-up-short text-success' : 'bi-arrow-down-short text-danger'); ?>"></i>
                                    <span class="small fw-medium <?php echo e($persenGuru >= 0 ? 'text-success' : 'text-danger'); ?>">
                                        <?php echo e(abs($persenGuru)); ?>%
                                    </span>
                                    <span class="small text-muted ms-2">dari tahun lalu</span>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <h2 class="dashboard-stat"><?php echo e($jumlahKelas); ?></h2>
                                <div class="mt-3 d-flex align-items-center">
                                    <i
                                        class="bi <?php echo e($persenKelas >= 0 ? 'bi-arrow-up-short text-success' : 'bi-arrow-down-short text-danger'); ?>"></i>
                                    <span class="small fw-medium <?php echo e($persenKelas >= 0 ? 'text-success' : 'text-danger'); ?>">
                                        <?php echo e(abs($persenKelas)); ?>%
                                    </span>
                                    <span class="small text-muted ms-2">dari tahun lalu</span>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <h2 class="dashboard-stat"><?php echo e($jumlahMapel); ?></h2>
                                <div class="mt-3 d-flex align-items-center">
                                    <i
                                        class="bi <?php echo e($persenMapel >= 0 ? 'bi-arrow-up-short text-success' : 'bi-arrow-down-short text-danger'); ?>"></i>
                                    <span class="small fw-medium <?php echo e($persenMapel >= 0 ? 'text-success' : 'text-danger'); ?>">
                                        <?php echo e(abs($persenMapel)); ?>%
                                    </span>
                                    <span class="small text-muted ms-2">dari tahun lalu</span>
                                </div>
                            </div>
                ...
                <div class="card shadow-sm border-0 h-100 rounded-4 overflow-hidden">
                    ...
                    <div class="card-body p-0">
                        <div class="list-group list-group-flush">
                            <?php $__currentLoopData = $topGuruMateri; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $guru): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h6 class="mb-0 fw-semibold text-dark"><?php echo e($guru->name); ?></h6>
                                            <p class="text-muted small mb-0"><i
                                                    class="bi bi-envelope-fill me-1 opacity-50"></i><?php echo e($guru->email); ?>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <span
                                            ...
                                            <i class="bi bi-file-earmark-text me-1"></i> <?php echo e($guru->materials_count); ?>
                    ...
                    <div class="card-footer bg-white border-top-0 text-center py-3">
                        <a href="<?php echo e(route('users.index')); ?>" class="btn btn-primary btn-sm rounded-pill px-4">
                            ...
                            <?php $__currentLoopData = $topMateri->sortByDesc('created_at'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $materi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h6 class="mb-0 fw-semibold text-dark"><?php echo e($materi->title); ?></h6>
                                            <div class="d-flex align-items-center mt-1">
                                                <span
                                                    class="badge bg-secondary bg-opacity-10 text-secondary me-2 rounded-pill">
                                                    <i
                                                        class="bi bi-bookmark-fill me-1"></i><?php echo e($materi->classModel->name); ?>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <span
                                            ...
                                            <i class="bi bi-door-open me-1"></i> <?php echo e($materi->class_count); ?> Kelas
                                        </span>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
